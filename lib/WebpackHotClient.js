...
import { reportBuildError, dismissBuildError, startReportingRuntimeErrors, stopReportingRuntimeErrors } from 'react-error-overlay';
...
startReportingRuntimeErrors({ launchEditorEndpoint, filename: '/client.js' });
